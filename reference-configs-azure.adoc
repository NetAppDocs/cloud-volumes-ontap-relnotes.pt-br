...
NOTE: Você pode usar as configurações a seguir com as implantações de blob de página HA do Cloud Volumes ONTAP existentes no Azure. Blobs de página não são suportados para novas implantações.
